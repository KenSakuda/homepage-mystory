        ...
        main={
          <>
            ...
            <AnalyticsOutsourceSection
              ...
              reasonsTitle="ダイナミックシェアが選ばれる理由"
              reasons={[
                {
                  term: "競争×時間を同時に扱う生態学モデル",
                  desc: "ロトカ・ヴォルテラをベースに、競合関係・広告減衰・季節性などの時間変化をモデル化。従来の定常モデルでは難しかった“介入後のシェア推移”を高精度に推定します。",
                },
                {
                  term: "コンジョイント連携で新商品・価格改定にも対応",
                  desc: "効用（全体効用／属性効用）を推定し、価格・機能・デザイン変更がシェアに与える影響を定量化。『データ分析 需要予測』の観点で新商品のシェア予測も可能です。",
                },
                {
                  term: "小規模データから段階導入できる設計",
                  desc: "数千件規模のアンケートや数カ月の販売データから開始し、段階的に精度を高める運用が可能。まずは小さく試し、精度検証後に全社展開できます。",
                },
                {
                  term: "意思決定に直結する可視化とルール化",
                  desc: "投資判断（参入／撤退）、差別化要因の特定、プライシングの中長期影響評価をダッシュボードで可視化。上申・合意形成まで一気通貫で支援します。",
                },
              ]}
