...
export default function Page() {
  ...
  return (
    <main className={styles.page}>
      <Hero
        image={{ src: "/data_analytics_peopleanalytics_hero.png", alt: "hero" }}
        title="ピープルアナリティクス"
      />
          ...
          <>
            ...
            <FeatureHighlights
              ...
              items={[
                ...
                },
                {
                  ...
                  lead: "評価が高い人・成果を出す人は“カリスマだから優秀”で片づけてしまいがちですが、私たちはそこを曖昧にしません。計量経済学の枠組み（固定効果モデル・操作変数法など）や、切断・打ち切り・選択バイアスを扱うトービット／ヘーキット等のモデルを使い、部署・上司・案件難度といった環境要因を丁寧にコントロールしたうえで「本当に効いている要素」を抽出します。結果として“優秀な人の属人的な武勇伝”ではなく、“再現できる成功条件”として制度や育成に落とせます。",
                  image: {
            ...
            <AnalyticsOutsourceSection
              ...
              reasons={[
                {
                  term: "人事特化",
                  desc: "離職予兆の可視化、ハイパフォーマーの要因分析、配属マッチング、採用ROI改善など、人事・タレントマネジメント領域に特化したピープルアナリティクスを提供。一般的なBIダッシュボード作成ではなく、「誰を・どこに・今どう動かすべきか」という具体的なアクションまで提示します。",
                },
                {
                  term: "再現性",
