...
export default function Page() {
  const sidebarLinks = [
    { href: "#", label: "受託データ分析 / データ分析コンサルティング" },
        ...
        main={
          <>
            ...
            <FeatureHighlights
              ...
              items={[
                {
                  subtitle: "高速に成果へ繋ぐアプローチ",
                  lead: "課題定義→仮説→実験設計→検証の短サイクル。統計/機械学習に、行動経済学・消費者行動理論を組み合わせ、施策に直結する示唆を提供します。",
                  image: {
                ...
                {
                  subtitle: "学際知を統合した意思決定支援",
                  lead: "コンジョイントや因果推論で得た結果に、おとり効果・フレーミング等の理論を重ね、価格/プラン/メッセージを“人が動く設計”に落とし込みます。",
                  image: {
                    src: "/data_analytics_consulting_2.png",
                    alt: "特徴02",
                  },
                ...
                {
                  subtitle: "現場で使える成果物",
                  lead: "ダッシュボード、検証テンプレ、運用ガイドラインなど、部署横断で再現可能な形でお渡し。継続的な改善と内製化を支援します。",
                  image: {
                    src: "/data_analytics_consulting_2.png",
                    alt: "特徴03",
                  },
                ...
                {
                  subtitle: "体制・運用まで伴走",
                  lead: "ABテスト設計・レビュー、定例での合意形成、KPI運用まで伴走。成果が出るまで責任を持ってやり切ります。",
                  image: {
                    src: "/data_analytics_consulting_2.png",
                    alt: "特徴04",
                  },
