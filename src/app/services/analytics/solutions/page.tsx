        ...
        items={[
          {
            ...
            contents: [
              ...
              {
                icon: "/check-mark.svg",
                title: "マーケティング施策の意思決定を科学的にサポート",
                description:
                  "ブランドポジショニングや商品設計、価格戦略、販促配分の最適化など、マーケティングのあらゆる意思決定において、「未来のシェアをどう動かすか」は重要な視点です。ダイナミックシェアは、施策によるシェアの変化を定量的に可視化するため、経営判断における「納得感」や「再現性」を高めることができます。",
              },
            ],
          },
          {
